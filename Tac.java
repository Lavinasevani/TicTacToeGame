...
public class Tac {
	...
	private void initialize() {
		...
		xCount.setText("0");
		panel_9.add(xCount, BorderLayout.CENTER);
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame,"Confirm You want To Exit ?","Tac",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
			}
		});
